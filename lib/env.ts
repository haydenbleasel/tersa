...
export const env = createEnv({
  ...
  server: {
    ...
    POLAR_PRO_PRODUCT_MONTHLY_ID: z.string().min(1),
    POLAR_PRO_PRODUCT_YEARLY_ID: z.string().min(1),
  ...
  runtimeEnv: {
    ...
    POLAR_PRO_PRODUCT_MONTHLY_ID: process.env.POLAR_PRO_PRODUCT_MONTHLY_ID,
